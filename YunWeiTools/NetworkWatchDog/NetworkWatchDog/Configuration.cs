...
namespace NetworkWatchDog
{
    ...
    public class IpGroup
    {
        ...
        {
            if(DateTime.Now>=new DateTime(DateTime.Now.Year,DateTime.Now.Month,DateTime.Now.Day,7,30,0)||DateTime.Now<=new DateTime(DateTime.Now.Year,DateTime.Now.Month,DateTime.Now.Day,23,30,0))
            {
